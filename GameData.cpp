...
{
	const char* filenames[NUM_TEXTURES] = {"title", "instructions", "pause", "gameover", "button_quit", "button_start","button_help", "button_restart", "button_mainmenu", "cursor", "lantern"};
...
{
	const char* filenames[NUM_SPRITES] = {"Player1", "Player2", "Fire", "Fire2", "Alien1", "Bullet", "LifeHUD", "ThreeShotWeapon", "FiveShotWeapon", "Flamethrower", "FirstAidKit"};
...
{
	const char* filenames[NUM_SOUNDS] = {"Jungle_Theme", "Boss_Battle", "Title_Theme", "Game_Over", "gun", "flamer", "Stage_Clear", "Ending_Theme"};
	const bool loop[NUM_SOUNDS] = {true, true, false, false, false, false, false, false};
	const float volumes[NUM_SOUNDS] = {1.0f, 1.0f, 1.0f, 1.0f, 0.5f, 0.8f, 1.0f, 1.0f};
