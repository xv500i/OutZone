...
{
	const char* filenames[NUM_SPRITES] = {"Player1", "Player2", "Fire", "Fire2", "Alien1", "Bullet", "LifeHUD", "SingleShotWeapon", "ThreeShotWeapon", "FiveShotWeapon", "Flamethrower", "FirstAidKit", "WeaponHUD", "Alien2", "Alien3", "Spider1", "Spider2", "Explosion", "boss", "tentacle_piece", "tentacle_base", "tentacle_weapon", "Victory", "DeathWall"};
...
{
	const char* filenames[NUM_SOUNDS] = {"Jungle_Theme", "Boss_Battle", "Title_Theme", "Game_Over", "gun", "flamer", "Stage_Clear", "Ending_Theme", "roar", "enemy_hit", "player_hit", "scream", "explosion"};
	const bool loop[NUM_SOUNDS] = {true, true, false, false, false, false, false, false, false, false, false, false, false};
	const float volumes[NUM_SOUNDS] = {1.0f, 1.0f, 1.0f, 1.0f, 0.3f, 0.8f, 1.0f, 1.0f, 0.8f, 1.5f, 1.0f, 1.0f, 2.8f};
