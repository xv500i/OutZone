...
private:
	/* Textures */
	const static int NUM_TEXTURES = 11;		// TOCHANGE: modificar depenent del numero de textures carregades
	...
	/* Sprites */
	const static int NUM_SPRITES = 7;		// TOCHANGE: modificar depenent del numero de sprites carregats
	const static char* SPRITE_EXT;

	/* Sounds */
	const static int NUM_SOUNDS = 8;		// TOCHANGE: modificar depenent del numero de sons carregats
